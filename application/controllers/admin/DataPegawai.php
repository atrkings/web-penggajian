...
class dataPegawai extends CI_Controller
{
    ...
    public function tambahData()
    {
        ...
        $data['jabatan'] = $this->penggajianModel->get_data
            ('data_jabatan')->result();
        $this->load->view('templates_admin/header', $data);
        $this->load->view('templates_admin/sidebar');
    ...
    public function tambahDataAksi()
    {
        ...
        else
        {
            ...
            if($photo=''){}
                ...
                {
                    echo "Yah, Fotomu Gagal Terupload!";
                }
                else
                {
    ...
    public function updateDataAksi()
    {
        ...
        else
        {
            ...
            $this->penggajianModel->update_data('data_pegawai', $data, $where);
                $this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>Yey! Selamat, datamu berhasil di update</strong>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>');
    ...
    {
        $this->form_validation->set_rules('no_rek','Nomer Rekening','required|numeric');
    ...
    public function deleteData($id)
        {
            ...
            $this->session->set_flashdata('pesan','<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Yah, datamu berhasil terhapus</strong>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>');
